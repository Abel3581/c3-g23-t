...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers(HttpMethod.GET,"/api/v1/products/me").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/products/{id}").permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/v1/products/{id}").permitAll()
                .antMatchers(HttpMethod.POST,"/api/v1/carts").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/carts/{id}").permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/v1/carts/{id}").permitAll()
                .antMatchers(HttpMethod.PUT,"/api/v1/carts/{id}/close").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/carts/{id}/invoice").permitAll()
                .antMatchers(HttpMethod.PUT,"/api/v1/carts/{id}").permitAll()
                .antMatchers(HttpMethod.PUT,"/api/v1/carts/{id}/lineproduct/{idLine}").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/carts/active").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/carts").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/invoices/{id}").permitAll()
